...
<head>
    <meta charset="utf-8" />
	<meta name="Portfolio" content="En école de développeur full stack à Laplateforme situé à Marseille. Stacks: HTML/CSS/JavaScript/PHP."/>
    <title>Portfolio Emmanuel Cabassot: développeur full stack</title>
</head>
    ...
    <section class="propos" id="propos" data-spy>
        ...
        <section class="container_propos">
            <section id="about" data-spy>
                <p>J'ai commencé ma reconversion de développeur à laplateforme en septembre 2020 et j'adore ça!
                    Quand le 'travail' devient un plaisir, que demander de plus. <br><br>
                    Le cursus dure 2ans. La méthode est simple: learning by doing. A la clef beaucoup de projet en solo ou en groupe. Au programme nous avons HTML/CSS, PHP, JavaScript et ensuite les frameworks tels que Symphony et React.
                    La deuxième année est en alternance.<br><br>
                    J'apprends vite, j'ai un fort esprit logique, une grande capacité de travail, un bon esprit d'équipe et j'aime les gens.
                </p>
                <p class="contact">
